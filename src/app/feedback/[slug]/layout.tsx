...
const Layout = ({
    ...
    const steps: Step[] = [
        { name: "General Info", path: "info", href: `/feedback/${portfolioSlug}/info` },
        { name: "Feedback Selection", path: "chips", href: `/feedback/${portfolioSlug}/chips` },
        { name: "Comments", path: "comments", href: `/feedback/${portfolioSlug}/comments` },
    ]
        ...
        <>
            ...
            >
                ...
                <Button variant="ghost" className="ml-auto w-fit" asChild>
                    <a href={`/portfolios/${portfolioSlug}`}>Back to portfolio</a>
                </Button>
            </header>
