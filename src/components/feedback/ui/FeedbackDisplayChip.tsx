...
export default function FeedbackDisplayChip({
    ...
    return (
        <div className="w-full flex flex-col gap-4 rounded-lg border transition-colors p-4 text-left bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-800">
