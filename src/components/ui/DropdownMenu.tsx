...
const DropdownMenuWithNoScroll = React.forwardRef(
  (props: any, ref: any) => (
    <DropdownMenuPrimitives.Root modal={false} onOpenAutoFocus={(e: Event) => e.preventDefault()} ref={ref} {...props} />
  )
)
DropdownMenuWithNoScroll.displayName = "DropdownMenu"

export {
  DropdownMenuWithNoScroll as DropdownMenu,
  DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuGroup, DropdownMenuIconWrapper, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioGroup,
