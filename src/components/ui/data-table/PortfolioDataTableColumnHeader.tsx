...
interface PortfolioDataTableColumnHeaderProps<TData, TValue>
    extends React.HTMLAttributes<HTMLDivElement> {
    column: Column<TData, TValue>
    title: string
}

export function PortfolioDataTableColumnHeader<TData, TValue>({
    column,
    title,
    className,
}: PortfolioDataTableColumnHeaderProps<TData, TValue>) {
