      ...
      <DropdownMenu open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <DropdownMenuGroup>
            ...
            <DropdownMenuItem onClick={() => handleNavigation("/user/account")}>
              Account
            </DropdownMenuItem>
            {profile?.is_admin ? (
              <DropdownMenuItem onClick={() => handleNavigation("/admin/portfolios")}>
                Admin
              </DropdownMenuItem>
            ) : (
              <DropdownMenuItem onClick={() => handleNavigation("/portfolio/overview")}>
                My Portfolio
              </DropdownMenuItem>
            )}
          </DropdownMenuGroup>
