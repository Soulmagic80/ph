...
begin
  ...
  foreach v_chip_id in array p_positive_chips loop
    ...
    insert into portfolio_rating (portfolio_id, feedback_chip_id, rating_type)
    values (p_portfolio_id, v_chip_id, 'positive');
  ...
  foreach v_chip_id in array p_negative_chips loop
    -- Insert into portfolio_rating
    insert into portfolio_rating (portfolio_id, feedback_chip_id, rating_type)
    values (p_portfolio_id, v_chip_id, 'negative');
